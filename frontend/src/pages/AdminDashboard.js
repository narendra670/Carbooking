                  ...
                  <tbody className="divide-y">
                    {bookings.map(booking => (
                      <tr key={booking._id} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 py-3 text-sm text-gray-600">{booking.car.oem} {booking.car.model}</td>
                        ...
                        <td className="px-4 py-3 text-sm font-medium text-gray-900">₹{booking.totalAmount.toLocaleString()}</td>
